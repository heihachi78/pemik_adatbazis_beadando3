create table fin_publicated_data as 
select b.account_number, b.bank_account_id, p.first_name, p.last_name, p.birth_name, p.person_id, c.partner_case_number, c.amount, c.case_id, now() as created_at
...
b.deleted_at is null and h.deleted_at is null and p.deleted_at is null and d.deleted_at is null and c.deleted_at is null
...
WHEN NOT MATCHED THEN
  ...
  VALUES (t.account_number, t.bank_account_id, t.first_name, t.last_name, t.birth_name, t.person_id, t.partner_case_number, t.amount, t.case_id, now());
...
INSERT INTO pgagent.pga_job(
    ...
    1::integer, 'fin_publicated_data_refresh_job'::text, ''::text, 'fin'::text, true
...
INSERT INTO pgagent.pga_schedule(
    ...
    jid, 'fin_publicated_data_refresh_sch'::text, ''::text, true,
    '2025-03-16 00:00:00 +01:00'::timestamp with time zone, 
    -- Minutes
